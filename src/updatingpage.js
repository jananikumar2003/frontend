...
export const UpadatingPage=(myindex)=>
{
    const [pos,setPos]=useState(myindex.who);

    const[orderdetails,setOrderdetails]=useState(
        {
            "firstname":myindex.mention.firstname,
            "lastname":myindex.mention.lastname,
            "email":myindex.mention.email,
            "address":myindex.mention.address,
            "city":myindex.mention.city,
            "state":myindex.mention.state,
            "phonenumber":myindex.mention.phonenumber,
            "itemname":myindex.mention.itemname,
            "totalamount":myindex.mention.totalamount,
        })
